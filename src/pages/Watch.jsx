...
function ShowminePlayer({ url, streamType, title, onBack }) {
  ...
  const [showSkip, setShowSkip] = useState(null); // 'forward' | 'backward'
    ...
    >
      ...
      {loading && (
        <div style={{
          ...
          <div style={{
            width: 48, height: 48, border: '3px solid rgba(255,255,255,.15)',
      ...
      {error && (
        <div style={{
          ...
          flexDirection: 'column', gap: 12, zIndex: 5
        }}>
      ...
      {showSkip && (
        <div style={{
          ...
          zIndex: 6, background: 'rgba(0,0,0,.5)',
      ...
      {showVolume && (
        <div style={{
          ...
          zIndex: 6, background: 'rgba(0,0,0,.6)', borderRadius: 12,
      ...
      <div style={{
        ...
        background: showControls ? 'linear-gradient(to top, rgba(0,0,0,.85) 0%, transparent 30%, transparent 70%, rgba(0,0,0,.6) 100%)' : 'none'
      }}>
        ...
        <div style={{
          ...
          <div style={{
            fontFamily: "'Barlow Condensed', sans-serif",
            fontSize: '.8rem', fontWeight: 900, letterSpacing: '.1em',
            color: '#e50914', opacity: .85
          }}>SHOWMINE</div>
        </div>
        ...
        <div style={{
          ...
          <button onClick={() => seek(-10)} style={{
            ...
            <svg width="26" height="26" viewBox="0 0 24 24" fill="white"><path d="M12.5 3C7.81 3 4 6.81 4 11.5S7.81 20 12.5 20c4.69 0 8.5-3.81 8.5-8.5 0-.34-.02-.68-.06-1.01l1.77-1.77C23.19 9.9 23.5 10.68 23.5 11.5 23.5 17.3 18.8 22 13 22S2.5 17.3 2.5 11.5 7.2 1 13 1c2.4 0 4.6.85 6.33 2.26L17.5 5.09A8.46 8.46 0 0012.5 3z"/><path d="M11 13.5v-5l-4 2.5 4 2.5zm2 0l4-2.5-4-2.5v5z" style={{display:'none'}}/><text x="7" y="15" fill="white" fontSize="6" fontWeight="bold">10</text></svg>
          </button>
          ...
          <button onClick={togglePlay} style={{
            ...
            boxShadow: '0 4px 20px rgba(229,9,20,.5)'
          }}>
            {playing
        ...
        <div style={{
          ...
          <div style={{ marginBottom: 10 }}>
            ...
            >
              <div style={{
                ...
                width: `${progress}%`, background: '#e50914', borderRadius: 2,
                transition: 'width .1s'
              }} />
              <div style={{
                position: 'absolute', top: '50%', transform: 'translateY(-50%)',
                ...
                background: '#e50914', boxShadow: '0 0 6px rgba(229,9,20,.8)'
              }} />
            </div>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
              ...
              <button onClick={() => {
                const vid = videoRef.current;
                if (vid) { vid.muted = !vid.muted; setMuted(!muted); }
              ...
              {levels.length > 0 && (
                <div style={{ position: 'relative' }}>
                  <button onClick={() => setShowQuality(q => !q)} style={{
                    ...
                    padding: '3px 8px', fontSize: '.7rem', fontWeight: 700,
                  ...
                  {showQuality && (
                    <div style={{
                      ...
                      borderRadius: 8, overflow: 'hidden', minWidth: 80
                    }}>
                      <button onClick={() => {
