  ...
  return (
    <div style={{ background: '#000', minHeight: '100vh', paddingBottom: '5rem' }}>
        ...
        <div style={{ padding: '16px 16px 0', maxWidth: 1400, margin: '0 auto' }}>
          ...
          {/* Section header when genre selected */}
          {genre && (
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16 }}>
              <button onClick={() => setParam('genre', '')} style={{
                background: 'rgba(255,255,255,.08)', border: 'none', color: '#fff',
                borderRadius: 20, padding: '6px 14px', cursor: 'pointer', fontSize: '.8rem'
              }}>Back</button>
              <span style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: '1.1rem', fontWeight: 800 }}>
                {SECTIONS.find(s => s.genre === genre)?.label || genre}
              </span>
            </div>
          )}
